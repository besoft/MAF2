...
IF (VTK_SOURCE_PATH)
  ...
  IF (VTK_FORCE_CONFIGURE OR NOT EXISTS ${VTK_BINARY_DIR}/build.cmake)
    ...
    EXEC_PROGRAM(${CMAKE_COMMAND} "${VTK_BINARY_PATH}" ARGS "${VTK_SOURCE_PATH}" -G"${CMAKE_GENERATOR}" -DCMAKE_GENERATOR_PLATFORM=Win32 -DLIBRARY_OUTPUT_PATH:PATH="${LIBRARY_OUTPUT_PATH}" -DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}
