...
IF (CRYPTO_SOURCE_PATH)
  ...
  IF (CRYPTO_FORCE_CONFIGURE OR NOT EXISTS ${CRYPTO_BINARY_DIR}/build.cmake)
    ...
    EXEC_PROGRAM(${CMAKE_COMMAND} "${CRYPTO_BINARY_PATH}" ARGS "${CRYPTO_SOURCE_PATH}" -G"${CMAKE_GENERATOR}" -DCMAKE_GENERATOR_PLATFORM=Win32 -DLIBRARY_OUTPUT_PATH:PATH="${LIBRARY_OUTPUT_PATH}" -DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}
